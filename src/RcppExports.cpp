...
// Xbar_prop_c
Rcpp::List Xbar_prop_c(const arma::rowvec& gamma, const arma::rowvec& theta, Rcpp::ListOf<NumericMatrix>& kerMat, Rcpp::ListOf<NumericVector>& meas_times, Rcpp::ListOf<NumericMatrix>& covariates, const arma::vec& censor, const unsigned int& n, const unsigned int& p);
RcppExport SEXP _asynlong_Xbar_prop_c(SEXP gammaSEXP, SEXP thetaSEXP, SEXP kerMatSEXP, SEXP meas_timesSEXP, SEXP covariatesSEXP, SEXP censorSEXP, SEXP nSEXP, SEXP pSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(Xbar_prop_c(gamma, theta, kerMat, meas_times, covariates, censor, n, p));
    return rcpp_result_gen;
END_RCPP
}
// H_A_prop_c
Rcpp::List H_A_prop_c(const arma::rowvec& gamma, const arma::rowvec& theta, Rcpp::ListOf<NumericMatrix>& kerMat, Rcpp::ListOf<NumericVector>& meas_times, Rcpp::ListOf<NumericMatrix>& covariates, Rcpp::ListOf<NumericVector>& response, Rcpp::ListOf<NumericMatrix>& Xbar, Rcpp::ListOf<NumericVector>& XXtbar, Rcpp::ListOf<NumericVector>& XZtbar, Rcpp::ListOf<NumericMatrix>& Zbar, Rcpp::ListOf<NumericVector>& ZZtbar, Rcpp::ListOf<NumericVector>& S0, const arma::vec& censor, const unsigned int& n, const unsigned int& p);
RcppExport SEXP _asynlong_H_A_prop_c(SEXP gammaSEXP, SEXP thetaSEXP, SEXP kerMatSEXP, SEXP meas_timesSEXP, SEXP covariatesSEXP, SEXP responseSEXP, SEXP XbarSEXP, SEXP XXtbarSEXP, SEXP XZtbarSEXP, SEXP ZbarSEXP, SEXP ZZtbarSEXP, SEXP S0SEXP, SEXP censorSEXP, SEXP nSEXP, SEXP pSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::rowvec& >::type gamma(gammaSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::ListOf<NumericVector>& >::type XZtbar(XZtbarSEXP);
    Rcpp::traits::input_parameter< Rcpp::ListOf<NumericMatrix>& >::type Zbar(ZbarSEXP);
    Rcpp::traits::input_parameter< Rcpp::ListOf<NumericVector>& >::type ZZtbar(ZZtbarSEXP);
    Rcpp::traits::input_parameter< Rcpp::ListOf<NumericVector>& >::type S0(S0SEXP);
    Rcpp::traits::input_parameter< const arma::vec& >::type censor(censorSEXP);
    Rcpp::traits::input_parameter< const unsigned int& >::type n(nSEXP);
    Rcpp::traits::input_parameter< const unsigned int& >::type p(pSEXP);
    rcpp_result_gen = Rcpp::wrap(H_A_prop_c(gamma, theta, kerMat, meas_times, covariates, response, Xbar, XXtbar, XZtbar, Zbar, ZZtbar, S0, censor, n, p));
    return rcpp_result_gen;
END_RCPP
}
// long_asy_c
Rcpp::List long_asy_c(const arma::rowvec& gamma, const arma::rowvec& theta, Rcpp::ListOf<NumericMatrix>& kerMat, Rcpp::ListOf<NumericVector>& meas_times, Rcpp::ListOf<NumericMatrix>& covariates, Rcpp::ListOf<NumericMatrix>& Xbar, Rcpp::ListOf<NumericMatrix>& Zbar, Rcpp::ListOf<NumericVector>& XXtbar, Rcpp::ListOf<NumericVector>& response, const arma::mat& Hmat, const arma::mat& Amat, const arma::vec& censor, const unsigned int& n, const unsigned int& p);
RcppExport SEXP _asynlong_long_asy_c(SEXP gammaSEXP, SEXP thetaSEXP, SEXP kerMatSEXP, SEXP meas_timesSEXP, SEXP covariatesSEXP, SEXP XbarSEXP, SEXP ZbarSEXP, SEXP XXtbarSEXP, SEXP responseSEXP, SEXP HmatSEXP, SEXP AmatSEXP, SEXP censorSEXP, SEXP nSEXP, SEXP pSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::rowvec& >::type gamma(gammaSEXP);
    ...
    Rcpp::traits::input_parameter< const unsigned int& >::type n(nSEXP);
    Rcpp::traits::input_parameter< const unsigned int& >::type p(pSEXP);
    rcpp_result_gen = Rcpp::wrap(long_asy_c(gamma, theta, kerMat, meas_times, covariates, Xbar, Zbar, XXtbar, response, Hmat, Amat, censor, n, p));
    return rcpp_result_gen;
END_RCPP
}
// EE_c
...
// longest_prop_c
arma::vec longest_prop_c(const arma::rowvec& theta, const arma::rowvec& gamma, Rcpp::ListOf < NumericMatrix >& kerMat, Rcpp::ListOf < NumericVector >& meas_times, Rcpp::ListOf < NumericMatrix >& covariates, Rcpp::ListOf < NumericVector >& response, Rcpp::ListOf < NumericVector >& dlambda, const arma::vec& censor, const unsigned int& n, const unsigned int& p);
RcppExport SEXP _asynlong_longest_prop_c(SEXP thetaSEXP, SEXP gammaSEXP, SEXP kerMatSEXP, SEXP meas_timesSEXP, SEXP covariatesSEXP, SEXP responseSEXP, SEXP dlambdaSEXP, SEXP censorSEXP, SEXP nSEXP, SEXP pSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::rowvec& >::type theta(thetaSEXP);
    ...
    Rcpp::traits::input_parameter< const unsigned int& >::type n(nSEXP);
    Rcpp::traits::input_parameter< const unsigned int& >::type p(pSEXP);
    rcpp_result_gen = Rcpp::wrap(longest_prop_c(theta, gamma, kerMat, meas_times, covariates, response, dlambda, censor, n, p));
    return rcpp_result_gen;
END_RCPP
}
// longest_pur_c
...
static const R_CallMethodDef CallEntries[] = {
    {"_asynlong_Xbar_prop_c", (DL_FUNC) &_asynlong_Xbar_prop_c, 8},
    {"_asynlong_H_A_prop_c", (DL_FUNC) &_asynlong_H_A_prop_c, 15},
    ...
    {"_asynlong_longest_prop_c", (DL_FUNC) &_asynlong_longest_prop_c, 10},
